...
- 🎭 **[User Profile](docs/examples/scenario_9_user_profile.md)**: Automatically builds and updates user profiles based on historical conversations and behavioral data, supports personalized recommendations and customized services, enabling AI systems to better understand and serve each user
