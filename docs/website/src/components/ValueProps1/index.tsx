...
const translations: Record<string, Record<string, string>> = {
  en: {
    'valueProps.title': 'Why Choose SeekMem?',
  ...
  zh: {
    'valueProps.title': '为什么选择 SeekMem？',
            ...
            {activeComparison && (
              <div className={styles.comparison}>
                ...
                <div className={styles.comparisonData}>
                  {/* SeekMem Progress Bar */}
                  <div className={styles.progressItem}>
                    <div className={styles.progressLabel}>
                      <span>SeekMem</span>
                      <span className={styles.progressValue}>
                        {activeComparison.seekmem}{activeComparison.unit}
                      </span>
                    </div>
                    <div className={styles.progressBar}>
                      <div
                        className={`${styles.progressFill} ${styles.progressFillSeekMem}`}
                        style={{ width: `${getProgressPercentage(activeComparison.seekmem, maxValue)}%` }}
                      />
                    </div>
                  </div>
                  ...
                  <div className={styles.progressItem}>
                    ...
                    <div className={styles.progressBar}>
                      <div
                        className={`${styles.progressFill} ${styles.progressFillFullContext}`}
                        style={{ width: `${getProgressPercentage(activeComparison.fullContext, maxValue)}%` }}
                      />
                    </div>
                  </div>
