...
const translations: Record<string, Record<string, string>> = {
  en: {
    'valueProps.title': 'Why Choose SeekMem?-2',
  ...
  zh: {
    'valueProps.title': '为什么选择 SeekMem？-2',
              ...
              <div className={styles.comparison}>
                ...
                <div className={styles.comparisonData}>
                  ...
                  <div className={styles.gaugeItem}>
                    <div className={styles.gaugeLabel}>SeekMem</div>
                    <div className={styles.gaugeContainer}>
                      <svg className={styles.gaugeSvg} viewBox="0 0 200 120">
                        ...
                        <path
                          ...
                          strokeWidth="12"
                          strokeLinecap="round"
                          strokeDasharray={`${getGaugePercentage(activeComparison.seekmem, maxValue) * 2.51} 251`}
