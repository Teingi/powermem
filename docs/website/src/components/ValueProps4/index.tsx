...
const translations: Record<string, Record<string, string>> = {
  en: {
    'valueProps.title': 'Why Choose SeekMem?-4',
...
export default function ValueProps4() {
  ...
  // Digital dashboard style - no progress calculation needed
            ...
            {activeComparison && (
              <div className={styles.comparison}>
                ...
                <div className={styles.comparisonData}>
                  {/* Digital Dashboard Style */}
                  <div className={styles.dashboardGrid}>
                    {/* SeekMem Dashboard */}
                    <div className={`${styles.dashboardItem} ${styles.dashboardSeekMem}`}>
                      <div className={styles.dashboardLabel}>SeekMem</div>
