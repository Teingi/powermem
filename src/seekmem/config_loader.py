"""
Configuration loader for seekmem
...
from seekmem.integrations.embeddings.config.providers import CustomEmbeddingConfig
from seekmem.integrations.embeddings.config.sparse_base import BaseSparseEmbedderConfig
from seekmem.integrations.llm.config.base import BaseLLMConfig
from seekmem.settings import _DEFAULT_ENV_FILE, settings_config
...
class TelemetrySettings(_BasePowermemSettings):
    ...
    endpoint: str = Field(
        default="https://telemetry.seekmem.ai",
...
class LoggingSettings(_BasePowermemSettings):
    ...
    file: str = Field(default="./logs/seekmem.log")
...
class GraphStoreSettings(_BasePowermemSettings):
    ...
    def to_config(
        ...
        from seekmem.storage.config.base import BaseGraphStoreConfig
...
def load_config_from_env() -> Dict[str, Any]:
    ...
    Example:
        ```python
        from dotenv import load_dotenv
        from seekmem.config_loader import load_config_from_env
...
def create_config(
    ...
    Example:
        ```python
        from seekmem.config_loader import create_config
        from seekmem import Memory
...
def validate_config(config: Dict[str, Any]) -> bool:
    ...
    Example:
        ```python
        from seekmem.config_loader import load_config_from_env, validate_config
