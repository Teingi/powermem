...
class OpenAIEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.openai.OpenAIEmbedding"
...
class QwenEmbeddingConfig(BaseEmbedderConfig):
    _provider_name = "qwen"
    _class_path = "seekmem.integrations.embeddings.qwen.QwenEmbedding"
...
class SiliconFlowEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.siliconflow.SiliconFlowEmbedding"
...
class HuggingFaceEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.huggingface.HuggingFaceEmbedding"
...
class OllamaEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.ollama.OllamaEmbedding"
...
class LMStudioEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.lmstudio.LMStudioEmbedding"
...
class AzureOpenAIEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.azure_openai.AzureOpenAIEmbedding"
...
class GeminiEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.gemini.GoogleGenAIEmbedding"
...
class VertexAIEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.vertexai.VertexAIEmbedding"
...
class TogetherEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.together.TogetherEmbedding"
...
class AWSBedrockEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.aws_bedrock.AWSBedrockEmbedding"
...
class ZaiEmbeddingConfig(BaseEmbedderConfig):
    _provider_name = "zai"
    _class_path = "seekmem.integrations.embeddings.zai.ZaiEmbedding"
...
class LangchainEmbeddingConfig(BaseEmbedderConfig):
    ...
    _class_path = "seekmem.integrations.embeddings.langchain.LangchainEmbedding"
...
class MockEmbeddingConfig(BaseEmbedderConfig):
    _provider_name = "mock"
    _class_path = "seekmem.integrations.embeddings.mock.MockEmbeddings"
