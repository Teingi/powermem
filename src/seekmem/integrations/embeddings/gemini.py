...
class GoogleGenAIEmbedding(EmbeddingBase):
    def __init__(self, config: Optional[BaseEmbedderConfig] = None):
        ...
        output_dimensionality = getattr(self.config, "output_dimensionality", None)
        self.config.embedding_dims = self.config.embedding_dims or output_dimensionality or 768
