...
def get_current_datetime() -> datetime:
    ...
    This function is used throughout seekmem to get the current time in the
    ...
    Note:
        All timestamps in seekmem (created_at, updated_at, etc.) are generated
...
def load_config_from_env() -> Dict[str, Any]:
    ...
    .. deprecated:: 0.1.0
       ...
       Please use ``from seekmem import load_config_from_env`` instead.
